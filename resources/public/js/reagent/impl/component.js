...
reagent.impl.component.state = (function reagent$impl$component$state(this$){
return cljs.core.deref.call(null,reagent.impl.component.state_atom.call(null,this$));
});
reagent.impl.component.replace_state = (function reagent$impl$component$replace_state(this$,new_state){
return cljs.core.reset_BANG_.call(null,reagent.impl.component.state_atom.call(null,this$),new_state);
});
reagent.impl.component.set_state = (function reagent$impl$component$set_state(this$,new_state){
...
var _STAR_current_component_STAR_22482 = reagent.impl.component._STAR_current_component_STAR_;
reagent.impl.component._STAR_current_component_STAR_ = C;

try{var f = (C[reagent.impl.component.cljs_render]);
var _ = (cljs.core.truth_(reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null))))].join('')))})());
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_22482;
}});
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__22486 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__22486) {
...
return (function() { 
var G__22488__delegate = function (args){
var C = this;
...
while (G__22489__i < G__22489__a.length) {G__22489__a[G__22489__i] = arguments[G__22489__i + 0]; ++G__22489__i;}
  args = new cljs.core.IndexedSeq(G__22489__a,0);
} 
...
var args = cljs.core.seq(arglist__22490);
...
if(cljs.core.truth_((function (){var and__16751__auto__ = wrap;
...
reagent.impl.component.add_render = (function reagent$impl$component$add_render(fun_map,render_f){
...
reagent.impl.component.wrap_funs = (function reagent$impl$component$wrap_funs(fun_map){
var render_fun = (function (){var or__16763__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__16763__auto__)){
return or__16763__auto__;
} else {
...
var _ = (cljs.core.truth_(reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"render-fun","render-fun",-1209513086,null))))].join('')))})());
var name = (function (){var or__16763__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__16763__auto__)){
return or__16763__auto__;
} else {
var or__16763__auto____$1 = render_fun.displayName;
...
var G__22494 = o;
(G__22494[cljs.core.name.call(null,k)] = v);
...
reagent.impl.component.create_class = (function reagent$impl$component$create_class(body,as_component){
...
while (G__22496__i < G__22496__a.length) {G__22496__a[G__22496__i] = arguments[G__22496__i + 0]; ++G__22496__i;}
  args = new cljs.core.IndexedSeq(G__22496__a,0);
} 
